...
use Modules\Icommercepaypal\Http\Requests\CreatePaypalconfigRequest;
use Modules\Icommercepaypal\Http\Requests\UpdatePaypalconfigRequest;
use Modules\Icommercepaypal\Repositories\PaypalconfigRepository;
use Modules\Core\Http\Controllers\Admin\AdminBaseController;
use Modules\Setting\Repositories\SettingRepository;

class PaypalconfigController extends AdminBaseController
{
    /**
    ...
    private $setting;
    public function __construct(PaypalconfigRepository $paypalconfig,SettingRepository $setting)
    {
        parent::__construct();
     ...
     *
     * @param  CreatePaypalconfigRequest $request
     * @return Response
     */
    public function store(CreatePaypalconfigRequest $request)
    {
     ...
     * @param  UpdatePaypalconfigRequest $request
     * @return Response
     */
    public function update(UpdatePaypalconfigRequest $request)
    {
        ...
        foreach ($data as $key => $val)
            $newData['icommercepaypal::'.$key ]= $val;
        $newData['icommercepaypal::image']=$requestimage;
